...
namespace ClientApp
{
    class Program
    {
        ...
        static void ListAllProducts()
        {
            ...
            var products = resp.Content.ReadAsAsync<IEnumerable<WebApiSelfHost.Model.Product>>().Result;
        ...
        static void ListProduct(int id)
        {
            ...
            var product = resp.Content.ReadAsAsync<WebApiSelfHost.Model.Product>().Result;
